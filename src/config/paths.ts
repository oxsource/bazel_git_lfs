...
function globalConfigFile(env: NodeJS.ProcessEnv = process.env): string {
...
export const paths = { globalConfigDir, globalConfigFile, projectConfigDir, projectConfigFile };
